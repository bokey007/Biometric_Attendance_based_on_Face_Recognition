...
def login():
    ...
    print('there is no consol')
    if user == 'DIAT_admin' and paswd == 'DIAT_admin':
...
def upload():
    ...
    target = os.path.join(APP_ROOT, "known/")
    ...
    if not os.path.isdir(target1):
        os.mkdir(target1)
    shutil.copyfile(APP_ROOT + "/" + "image.jpeg", target1 + str(str(request.form["folder_name"])+id_folder+".jpeg"))
    destination = APP_ROOT + "/" + "known/" + test_append + "/" + "image.jpeg"
...
def view_report():
    ...
    data = pickle.loads(open('encodings_test_hog.pickle', "rb").read())
    ...
    with open('knn_classifire_test_hog.pickle', 'wb') as f:
        pickle.dump(knn_clf, f)

    print("classifire trained")

    copyfile('C:/Users/bokey/attendace_system/face_recognition_for_diat/register_new_user_and_train/face-recognition-based-attendance-system-master/teachers_site/encodings_test_hog.pickle', 'C:/Users/bokey/attendace_system/face_recognition_for_diat/video-streamer-master/cv/encodings_test_hog.pickle')

    copyfile('C:/Users/bokey/attendace_system/face_recognition_for_diat/register_new_user_and_train/face-recognition-based-attendance-system-master/teachers_site/encodings_test_hog.pickle', 'C:/Users/bokey/attendace_system/face_recognition_for_diat/video-streamer-master-exit/cv/encodings_test_hog.pickle')

    copyfile('C:/Users/bokey/attendace_system/face_recognition_for_diat/register_new_user_and_train/face-recognition-based-attendance-system-master/teachers_site/knn_classifire_test_hog.pickle', 'C:/Users/bokey/attendace_system/face_recognition_for_diat/video-streamer-master/cv/knn_classifire_test_hog.pickle')

    copyfile('C:/Users/bokey/attendace_system/face_recognition_for_diat/register_new_user_and_train/face-recognition-based-attendance-system-master/teachers_site/knn_classifire_test_hog.pickle', 'C:/Users/bokey/attendace_system/face_recognition_for_diat/video-streamer-master-exit/cv/knn_classifire_test_hog.pickle')

    print('files copied')

    return render_template("task.html", title="Faculty Login", msg="Model is Training Complete")
...
def logout():
    return render_template("index.html", title="Faculty Login", msg="Logged out please login again")
...
if (__name__ == '__main__'):
    ...
    app.run(host='localhost', port=4545, debug=True)